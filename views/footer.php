...
<?php } else { ?>
    ...
    target="_blank"></a>
			...
			<a class="footer-btn share-btn" title="<?php echo Kohana::lang('ui_main.tt-twitter'); ?>" id="footer-btn-tw" onclick="return !window.open(twitter_share,'das2','location=,links=no,scrollbars=no,toolbar=no,width=520,height=350')" href="#"></a>
...
function SelectAll(id)
{
	...
	<div id="popup-spread" class="reveal-modal"><?php echo Kohana::lang('ui_main.footer-spread-popup'); ?>
		<iframe name='reevo_map' src='http://map.reevo.org/?embed=&l=<?php echo Kohana::config('locale.language.0'); ?>' width="540" height="340" frameborder="0"></iframe>
